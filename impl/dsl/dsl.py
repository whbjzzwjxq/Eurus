...
class AFLAction:
    def __init__(self, action_name: str, args_in_name: List[str], args: List[str], concrete: bool = False) -> None:
        ...
        self._token_flows: List[Tokenflow] = None
        self._constraints: List[ACTION_CONSTR] = None
    ...
    @property
    def token_flows(self):
        if self._token_flows is None:
            raise RuntimeError("This AFLAction's token flows haven't been inferred!")
        return self._token_flows

    @property
    def constraints(self):
        if self._constraints is None:
            raise RuntimeError("This AFLAction's constraints haven't been inferred!")
        return self._constraints

    def update(self, token_flows=None, constraints=None):
        self._token_flows = token_flows
    ...
    def symbolic_copy(self, arg_start_index: int) -> "AFLAction":
        ...
        action.update(self._token_flows, self._constraints)
        return action
