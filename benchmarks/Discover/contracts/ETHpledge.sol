...
contract ETHpledge is IERC20, Ownable {
    ...
    function pledgein(
        ...
        require(
            ...
            "The recommended address cannot be your own"
        );
        ...
        if (day22 == 0) {
            day2 = 10;
            income[msg.sender] = _s10;
        }
        if (day22 == 5) {
            day2 = 5;
            income[msg.sender] = _s5;
        }
        if (day22 == 6) {
            day2 = 6;
            income[msg.sender] = _s6;
        }
        if (day22 == 7) {
            day2 = 7;
            income[msg.sender] = _s7;
        }
        if (day22 == 8) {
            day2 = 8;
            income[msg.sender] = _s8;
        }
        if (day22 == 9) {
            day2 = 9;
            income[msg.sender] = _s9;
        }
        if (day22 == 10) {
            day2 = 10;
            income[msg.sender] = _s10;
