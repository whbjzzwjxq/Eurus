...
import {IOracle} from "./ChainlinkOracleV2.sol";
...
contract CauldronMediumRiskV1 is BoringOwnable, IMasterContract {
    ...
    constructor(address bentoBoxAddr, address magicInternetMoneyAddr, address xSushiAddr) {
        bentoBox = IBentoBoxV1(bentoBoxAddr);
        magicInternetMoney = IERC20(magicInternetMoneyAddr);
        xSushi = IERC20(xSushiAddr);
        masterContract = this;
        exchangeRate = 387970202315884682;
        totalBorrow = Rebase(2329911527857458168919, 2280568538545677306855);
    }
    ...
    function init(bytes calldata data) public payable override {
        ...
        (collateral, oracle, oracleData) = abi.decode(
            data,
            (IERC20, IOracle, bytes)
        );
    ...
    function updateExchangeRate() public returns (bool updated, uint256 rate) {
        ...
        // }
        // Hack the rate
        // exchangeRate0 = 387970202315884682;
        // exchangeRate1 = 533537989524363604;
        exchangeRate = 81.8 ether * xSushi.balanceOf(address(bentoBox)) / magicInternetMoney.balanceOf(address(bentoBox));
    }
    ...
    function reduceSupply(uint256 amount) public {
        ...
        MIM(address(magicInternetMoney)).burn(amount);
    }
}
