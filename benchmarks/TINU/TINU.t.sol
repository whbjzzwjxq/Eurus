...
contract TINUTest is Test, BlockLoader {
    ...
    function check_gt(
        ...
        vm.assume(amt4 == amt0 + 105164549999999988638);
        borrow_weth(amt0);
    ...
    function check_cand001(
        ...
        vm.assume(amt5 == amt0 + 105164549999999988638);
        borrow_weth(amt0);
        swap_pair_weth_tinu(amt1);
        burn_pair_tinu(amt2);
        swap_pair_tinu_weth(amt3);
    ...
    function check_cand005(
        ...
        vm.assume(amt6 == amt0 + 105164549999999988638);
        borrow_weth(amt0);
        swap_pair_weth_tinu(amt1);
        burn_pair_tinu(amt2);
        burn_pair_tinu(amt3);
    ...
    function check_cand009(
        ...
        vm.assume(amt7 == amt0 + 105164549999999988638);
        borrow_weth(amt0);
        swap_pair_weth_tinu(amt1);
        burn_pair_tinu(amt2);
        burn_pair_tinu(amt3);
    ...
    function check_cand013(
        ...
        vm.assume(amt8 == amt0 + 105164549999999988638);
        borrow_weth(amt0);
        swap_pair_weth_tinu(amt1);
        burn_pair_tinu(amt2);
        burn_pair_tinu(amt3);
